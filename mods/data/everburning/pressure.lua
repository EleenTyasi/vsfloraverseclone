...
function onCountdownStarted()
    ...
    if difficulty == 0 then
        ...
        debugPrint("Is this set to Easy? It should be 0.02.")
    elseif difficulty == 1 then
        pressure = pressure + 0.02
        debugPrint("Is this set to Normal? It should be 0.03.")
    elseif difficulty == 2 then
        pressure = pressure + 0.03
        debugPrint("Is this set to Hard? It should be 0.04.")
    elseif difficulty == 3 then
        pressure = pressure + 0.04
        debugPrint("Is this set to Hellsider? It should be 0.05.")
    end
