GameTitleStart = 'Vs. Floraverse (Psych Engine) - Puppetfunk' --game title thith song start
GameOverTitle = 'Vs. Floraverse (Psych Engine) - Ouch. That looks like it hurt.' --game over title
looseTitle = 'Vs. Floraverse (Psych Engine) - Puppetfunk' --looser title(if you have < 1 health)
maxLooseMisses = 1 --max loose misses
perfectTitle = 'Vs. Floraverse (Psych Engine) - Puppetfunk - FC'
