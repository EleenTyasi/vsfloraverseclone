GameTitleStart = 'Vs. Floraverse (Psych Engine) - Flashfire' --game title thith song start
GameOverTitle = 'Vs. Floraverse (Psych Engine) - You could not handle the heat.' --game over title
looseTitle = 'Vs. Floraverse (Psych Engine) - Flashfire' --looser title(if you have < 1 health)
maxLooseMisses = 1 --max loose misses
perfectTitle = 'Vs. Floraverse (Psych Engine) - Flashfire - PFC'
